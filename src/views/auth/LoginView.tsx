...
export default function LoginView(): JSX.Element {
    ...
    // Methods
    const login = async (event: any) => { // Send login request to server
        // Configs
                    ...
                    <div className="authentication-inner">
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                {/* <!-- /Logo --> */}
                                <h4 className="mb-2">Hey ! Bienvenue à bord ! 👋</h4>
                                <p className="mb-4">Connectez vous pour une nouvelle aventure.</p>
                                {/* Login result alert */}
                                {errorHappens ? <Alert type="danger" message={errorMsg} /> : null}
                                {/* Login form */}
                                <form id="formAuthentication" className="mb-3" onSubmit={login}>
                                    <div className="mb-3">
                                        ...
                                        <input
                                            ...
                                            id="email"
                                            name="email"
                                            placeholder="Ex: votrenom@service.com"
                                            required={true}
                                            value={email}
                                    ...
                                    <div className="mb-3">
                                        <div className="form-check">
                                            <input className="form-check-input" type="checkbox" id="remember-me" checked={remember} onChange={(event) => setRemember(event.target.checked)} />
                                            <label className="form-check-label" htmlFor="remember-me"> Rester connecté</label>
                                        </div>
                                    </div>
                                    <div className="mb-3">
