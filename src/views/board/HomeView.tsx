            ...
            <div className="d-flex align-items-end row">
              ...
              <div className="col-sm-5 text-center text-sm-left">
                <div className="card-body pb-0 px-0 px-md-4">
                  <img
                    src={process.env.PUBLIC_URL + '/template/assets/img/illustrations/man-with-laptop-light.png'}
                    height="140"
                    alt="View Badge User"
                    data-app-dark-img={process.env.PUBLIC_URL + '/template/assets/img/illustrations/man-with-laptop-dark.png'}
                    data-app-light-img={process.env.PUBLIC_URL + '/template/assets/img/illustrations/man-with-laptop-light.png'}
                  />
                </div>
              </div>
            </div>
                ...
                <div className="card-body">
                  <div className="card-title d-flex align-items-start justify-content-between">
                    <div className="avatar flex-shrink-0">
                      <img
                        src={process.env.PUBLIC_URL + '/template/assets/img/icons/unicons/chart-success.png'}
                        alt="chart success"
                        className="rounded"
                      />
                    </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="card-title d-flex align-items-start justify-content-between">
                    <div className="avatar flex-shrink-0">
                      <img
                        src={process.env.PUBLIC_URL + '/template/assets/img/icons/unicons/wallet-info.png'}
                        alt="Credit Card"
                        className="rounded"
                      />
                    </div>
            ...
            <div className="col-6 mb-4">
              <div className="card">
                <div className="card-body">
                  <div className="card-title d-flex align-items-start justify-content-between">
                    <div className="avatar flex-shrink-0">
                      <img src={process.env.PUBLIC_URL + '/template/assets/img/icons/unicons/paypal.png'} alt="Credit Card" className="rounded" />
                    </div>
                    <div className="dropdown">
                      <button
                        className="btn p-0"
            ...
            <div className="col-6 mb-4">
              <div className="card">
                <div className="card-body">
                  <div className="card-title d-flex align-items-start justify-content-between">
                    <div className="avatar flex-shrink-0">
                      <img src={process.env.PUBLIC_URL + '/template/assets/img/icons/unicons/cc-primary.png'} alt="Credit Card" className="rounded" />
                    </div>
                    <div className="dropdown">
                      <button
                        className="btn p-0"
              ...
              <div className="tab-content p-0">
                <div className="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                  <div className="d-flex p-4 pt-3">
                    <div className="avatar flex-shrink-0 me-3">
                      <img src={process.env.PUBLIC_URL + '/template/assets/img/icons/unicons/wallet.png'} alt="User" />
                    </div>
                    <div>
          ...
          <div className="card h-100">
            ...
            <div className="card-body">
              <ul className="p-0 m-0">
                <li className="d-flex mb-4 pb-1">
                  <div className="avatar flex-shrink-0 me-3">
                    <img src={process.env.PUBLIC_URL + '/template/assets/img/icons/unicons/paypal.png'} alt="User" className="rounded" />
                  </div>
                  <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div className="me-2">
                ...
                <li className="d-flex mb-4 pb-1">
                  <div className="avatar flex-shrink-0 me-3">
                    <img src={process.env.PUBLIC_URL + '/template/assets/img/icons/unicons/wallet.png'} alt="User" className="rounded" />
                  </div>
                  <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div className="me-2">
                ...
                <li className="d-flex mb-4 pb-1">
                  <div className="avatar flex-shrink-0 me-3">
                    <img src={process.env.PUBLIC_URL + '/template/assets/img/icons/unicons/chart.png'} alt="User" className="rounded" />
                  </div>
                  <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div className="me-2">
                ...
                <li className="d-flex mb-4 pb-1">
                  <div className="avatar flex-shrink-0 me-3">
                    <img src={process.env.PUBLIC_URL + '/template/assets/img/icons/unicons/cc-success.png'} alt="User" className="rounded" />
                  </div>
                  <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div className="me-2">
                ...
                <li className="d-flex">
                  <div className="avatar flex-shrink-0 me-3">
                    <img src={process.env.PUBLIC_URL + '/template/assets/img/icons/unicons/cc-warning.png'} alt="User" className="rounded" />
                  </div>
                  <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                    <div className="me-2">
